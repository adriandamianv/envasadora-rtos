...
def sembrar_datos():
    """Siembra los datos iniciales. Requiere un app context activo.
    Idempotente: si ya hay usuarios, no hace nada (así puede llamarse
    en cada arranque, p. ej. en Render donde no hay shell)."""
    db.create_all()
...
def sembrar():
    """Uso por consola: python seeds.py"""
